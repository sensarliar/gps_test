#############################################################################
# Makefile for building: gps_test_0618_1405
# Generated by qmake (2.01a) (Qt 4.8.3) on: ?? 6? 23 03:31:39 2014
...
DIST          = /home/gaoming/ti-sdk-am335x-evm-06.00.00.00/linux-devkit/sysroots/armv7ahf-vfp-neon-3.2-oe-linux-gnueabi/usr/share/qtopia/mkspecs/common/unix.conf \
		...
		gps_test.pro
QMAKE_TARGET  = gps_test_0618_1405
DESTDIR       = 
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/gps_test_0618_14051.0.0 || $(MKDIR) .tmp/gps_test_0618_14051.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/gps_test_0618_14051.0.0/ && $(COPY_FILE) --parents mainwindow.h .tmp/gps_test_0618_14051.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp .tmp/gps_test_0618_14051.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/gps_test_0618_14051.0.0/ && (cd `dirname .tmp/gps_test_0618_14051.0.0` && $(TAR) gps_test_0618_14051.0.0.tar gps_test_0618_14051.0.0 && $(COMPRESS) gps_test_0618_14051.0.0.tar) && $(MOVE) `dirname .tmp/gps_test_0618_14051.0.0`/gps_test_0618_14051.0.0.tar.gz . && $(DEL_FILE) -r .tmp/gps_test_0618_14051.0.0
